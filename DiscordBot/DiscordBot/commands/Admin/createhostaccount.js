...
module.exports = {
    commandInfo: {
        ...
        description: "Creates a host account for Eclipse."
    },
    execute: async (interaction) => {
        ...
        const existingHostAccount = await User.findOne({ email: "hostaccount@Eclipseapp.dev" });
        ...
        const username = "Eclipsebackendhostaccount";
        const email = "hostaccount@eclipseapp.dev";
