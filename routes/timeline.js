...
app.get("/fortnite/api/calendar/v1/timeline", async (req, res) => {
    ...
    todayAtMidnight.setHours(26, 0, 0, 0)
    ...
    var activeEvents = [
    {
        ...
        "activeUntil": "2025-09-09T08:00:00Z",
        "activeSince": "2025-09-09T08:00:00Z",
    },
    {
    ...
    if (memory.season == 8) {
        activeEvents.push(
        {
            ...
            "activeSince": "2024-01-01T00:00:00.000Z"
        },
        {
    ...
    const stateTemplate = {
        ...
        "seasonBegin": "2025-07-10T13:00:00Z",
        "seasonEnd": "2025-09-09T08:00:00Z",
        "seasonDisplayedEnd": "2025-09-09T08:00:00Z",
